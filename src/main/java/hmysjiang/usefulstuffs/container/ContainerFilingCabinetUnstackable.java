...
public class ContainerFilingCabinetUnstackable extends ContainerBase {
	...
	public ContainerFilingCabinetUnstackable(EntityPlayer player, BlockPos pos, int page) {
